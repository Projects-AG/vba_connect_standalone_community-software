...
export const contacts = [
  { id: 'c1', name: 'Sarah Jenkins', role: 'Product Design', avatar: 'https://i.pravatar.cc/150?img=5', status: 'online' },
  { id: 'c2', name: 'Marcus Bell', role: 'Engineering', avatar: 'https://i.pravatar.cc/150?img=13', status: 'away', initials: 'MB' },
  { id: 'c3', name: 'Elena Rodriguez', role: 'Frontend Lead', avatar: 'https://i.pravatar.cc/150?img=32', status: 'online' },
  { id: 'c4', name: 'Jordan Smith', role: 'Executive', avatar: 'https://i.pravatar.cc/150?img=51', status: 'online' },
  { id: 'c5', name: 'Kelly Lin', role: 'Operations', avatar: 'https://i.pravatar.cc/150?img=47', status: 'offline', initials: 'KL' },
  { id: 'c6', name: 'David Moore', role: 'Backend Engineer', avatar: 'https://i.pravatar.cc/150?img=14', status: 'online' },
  { id: 'c7', name: 'Maya Patel', role: 'Backend Engineer', avatar: 'https://i.pravatar.cc/150?img=25', status: 'online' },
  { id: 'c8', name: 'Marcus Thorne', role: 'Operations Lead', avatar: 'https://i.pravatar.cc/150?img=15', status: 'away' },
]
...
export const posts = [
  ...
  },
  {
    ...
    reply: { author: 'James Wilson', avatar: 'https://i.pravatar.cc/150?img=8', time: '4h ago', body: "Testing it now on the iPad Pro. It's incredibly fluid. Night and day difference." },
    likes: 12,
    comments: 3,
  },
]
...
export const files = [
  ...
  { id: 'f4', name: 'Budget_2024.xls', type: 'sheet', modified: 'Yesterday', author: 'Marcus T.', size: '850 KB' },
]
